                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                Tambah Barang pemeliharaan
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="container-fluid">
                                                        <?= validation_errors() ?>
                                                        <form action="<?= base_url('admin/proses_tambahpemeliharaan')  ?>" method="POST" enctype="multipart/form-data">
                                                            <table class="table">
                                                                <tr>
                                                                    <td width=20%>Tanggal Pemeliharaan</td>
                                                                    <td><input type="Date" name="tanggal_pemeliharaan" class="form-control" required placeholder="tanggal pemeliharaan"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Barang</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="tindakan" class="form-control" required placeholder="tindakan"></td>
                                                                </tr>
                                                                <tr>
