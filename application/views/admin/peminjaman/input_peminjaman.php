                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="container-fluid">
                                                        <?= validation_errors() ?>
                                                        <form action="<?= base_url('admin/proses_tambahpeminjaman')  ?>" method="POST" enctype="multipart/form-data">
                                                            <table class="table">
                                                                <tr>
                                                                    <td>Nama Pegawai</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="Date" name="tanggal_peminjaman" class="form-control" required placeholder="tanggal peminjaman"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Barang</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="tujuan" class="form-control" required placeholder="tujuan"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width=20%>Tanggal pengembalian</td>
                                                                    <td><input type="Date" name="tanggal_pengembalian" class="form-control" required placeholder="tanggal peminjaman"></td>
                                                                </tr>
