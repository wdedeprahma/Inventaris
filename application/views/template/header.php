...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" <?= base_url('admin/index') ?> " target="_blank">
        <img src="<?= base_url('assets/bglogin.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">MTsN 1 Katingan</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Barang</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_stokbarang') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-archive-2 text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Persedian Barang</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('admin/data_barang_masuk') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-download text-warning text-sm opacity-10"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('admin/data_barang_keluar') ?>">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('admin/data_pemeliharaan') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-tools text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Pemeliharaan Barang</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_audit') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-clipboard-check text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Audit Barang</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_peminjaman') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-handshake text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Peminjaman Barang</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_pengembalian') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-hand-holding text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Pengembalian Barang</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_hilang') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-exclamation-triangle text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Barang Hilang</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_pemusnahan') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-trash-alt text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Pemusnahan Barang</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('admin/data_supplier') ?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-copy-04 text-primary text-sm opacity-10"></i>
            </div>
